...
import ec.edu.ups.icc.fundamentos01.security.services.UserDetilsServicesImple;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private final UserDetilsServicesImple userDetailsService; // Para cargar usuario desde BD
    private final JwtProperties jwtProperties; // Configuración JWT (header, prefix)

    public JwtAuthenticationFilter(JwtUtil jwtUtil,
            UserDetilsServicesImple userDetailsService,
